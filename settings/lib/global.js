...
exports.commandNotFound = (tempo, sender, command, prefix, hora, data2, SoDono, isPremium) => { 
return `
╭═════════════════╮
『  *~_WELCOME_~*  』
╭═════════════════╯
| ೈ፝͜͡⚡ ${tempo} @${sender.split("@")[0]}, Você Errou o Comando.
| ೈ፝͜͡⚡ Comando Ultilizado: ${command}
| ೈ፝͜͡⚡ Recomendo Que Digite: ${prefix}Menu e Leia Os Comandos Corretamente.
 
|『   INFORMAÇÕES:  』 

| ೈ፝͜͡⚡ Hora: ${hora}
| ೈ፝͜͡⚡ Data: ${data2}
| ೈ፝͜͡⚡ Seu Numero: ${sender.split("@")[0]}
| ೈ፝͜͡⚡ Dono? ${SoDono ? "✅" : "❌"}
| ೈ፝͜͡⚡ Premium? ${isPremium ? "✅" : "❌"}
╰══════════════════•°•°`
}
